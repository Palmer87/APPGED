...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Documents Storage Disk
    |--------------------------------------------------------------------------
    |
    | Specify the disk where private tenant documents are stored.
    | Defaults to DOCUMENTS_DISK, then FILESYSTEM_DISK, then 'private'.
    | Supported: 'private', 'local', 's3', 'r2'
    |
    */
