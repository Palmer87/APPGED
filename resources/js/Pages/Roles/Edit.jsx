...
export default function RolesEdit({ role, isSystemRole = false, permissionsGrouped = [] }) {
    const form = useForm({
        name: role.name || '',
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-xs text-slate-500 mt-1">
                            Ajustez le niveau d'accès et les autorisations pour le rôle <span className="font-semibold text-slate-700">{role.name}</span>.
                        </p>
                    </div>
                </div>
                    ...
                    <div className="bg-white p-6 rounded-xl border border-slate-200/80 shadow-xs space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full max-w-md px-3 py-2 text-xs rounded-lg border border-slate-300 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 disabled:bg-slate-100 disabled:text-slate-500"
                            />
                            {isSystemRole && (
